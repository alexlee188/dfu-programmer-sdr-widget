...
pkgdatadir = $(datadir)/dfu-programmer
pkgincludedir = $(includedir)/dfu-programmer
pkglibdir = $(libdir)/dfu-programmer
pkglibexecdir = $(libexecdir)/dfu-programmer
...
DIST_COMMON = README $(am__configure_deps) $(srcdir)/Makefile.am \
	...
	$(top_srcdir)/fedora/dfu-programmer.spec.in AUTHORS COPYING \
	ChangeLog NEWS m4/depcomp m4/install-sh m4/missing
...
CONFIG_CLEAN_FILES = fedora/dfu-programmer.spec
...
STRIP = 
VERSION = 0.5.4
abs_builddir = /home/alex/dfu-programmer-0.5.4
abs_srcdir = /home/alex/dfu-programmer-0.5.4
abs_top_builddir = /home/alex/dfu-programmer-0.5.4
abs_top_srcdir = /home/alex/dfu-programmer-0.5.4
ac_ct_CC = gcc
am__include = include
am__leading_dot = .
am__quote = 
...
top_srcdir = .
SUBDIRS = src docs
EXTRA_DIST = bootstrap.sh fedora/10-dfu-programmer.fdi \
...
fedora/dfu-programmer.spec: $(top_builddir)/config.status $(top_srcdir)/fedora/dfu-programmer.spec.in
